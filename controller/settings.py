...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=3) if DEBUG else timedelta(minutes=30),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "CoPilot Assessment API",
    "VERSION": "1.0.0",
}

DRF_STANDARDIZED_ERRORS = {
    "EXCEPTION_HANDLER_CLASS": "drf_standardized_errors.handler.ExceptionHandler",
    "EXCEPTION_FORMATTER_CLASS": "includes.drf.formatters.AssessmentExceptionFormatter",
